...
<html>
    ...
    <style>
        ...
        <form method="GET" action="index.php">
            ...
            <input type="submit" class="btn btn-lg btn-success" value="FIND" style=background-color:#49e4fa;border-color:#49e4fa;color:black;padding-left:20px;padding-right:20px;border-radius:45%;>
        </form>
      </div>
<?php displayMessage();?>
