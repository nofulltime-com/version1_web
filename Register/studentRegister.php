...
<body>
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($usercount > 0) {
            ...
            $status = "notverified";
            $insert_data = "INSERT INTO users (username, email,phone, password, code, status)
        ...
        if($data_check){
            ...
            if(mail($email, $subject, $message, $sender)){
                ...
                header("Location: studentRegister.php?error=failed while sending code.");
            }
            }
            else{
                header("Location: studentRegister.php?error=failed while inserting into database.");
            }
