                    ...
                    <div class="col-lg-8 post-list blog-post-list">
                        <div class="single-post">
                            ...
                            <a onclick="return false;">
                                <h1>
                                    The web is working Latest Demanding courses
                                </h1>
                            </a>
                                ...
                                <div class="container">
                                    <div class="row justify-content-between">
                                        <div class="col-sm-6 nav-left justify-content-start d-flex">
                                            <div class="thumb">
                                                <img src="img/blog/blog-classroom.jpg" alt="" style=width:70px;height:70px;>
                                            </div>
                                            <div class="post-details">
                                                <p>Prev Post</p>
                                                <h4 class="text-uppercase"><a href="#">Outside Traditional Classrooms</a></h4>
                                            </div>
                                        </div>
