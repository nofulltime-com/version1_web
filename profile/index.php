					...
					<div class="row">
						<div class="col-lg-6">
							<div class="hero-text">
								...
								<p>I’m a digital designer in love with photography, painting and discovering new worlds
									and cultures.</p>
							</div>
							<div class="hero-info">
								<h2>General Info</h2>
								<ul>
									...
									<li><span>Martial-Status</span>Single</li>
									<li><span>Address</span>Rosia Road 55, Gibraltar, UK</li>
									<li><span>PIN code</span>522034</li>
